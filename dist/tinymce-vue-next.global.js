/*!
  ...
  * @license MIT
  */
var TinymceTinymceVueNext = (function (vue) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var bindModelHandlers = function (ctx, editor) {
        ...
        // @ts-ignore
        ctx.$watch('modelValue', function (val, prevVal) {
    ...
    var initEditor = function (initEvent, ctx, editor) {
        var value = ctx.$props.modelValue ? ctx.$props.modelValue : '';
     ...
     *
     */
    var renderInline = function (id, tagName) {
        return vue.h(tagName ? tagName : 'div', {
            id: id
        });
    };
    var renderIframe = function (id) {
